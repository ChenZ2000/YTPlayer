...
{
    public class YtDlpProvider : IProvider
    {
        private readonly string _ytDlpPath;

        public YtDlpProvider(string pathToYtDlp = "yt-dlp")
        {
        ...
        public async Task<AudioResult> CheckAsync(SongInfo info, CancellationToken ct)
        {
            ...
            if (string.IsNullOrEmpty(url)) throw new InvalidOperationException("yt-dlp empty url");
