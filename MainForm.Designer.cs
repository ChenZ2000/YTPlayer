...
this.fileMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] {
    ...
    this.exitMenuItem});
            ...
            // playControlMenuItem
            //
            this.playControlMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] {
            ...
            this.sequentialMenuItem,
            this.loopMenuItem,
            this.loopOneMenuItem,
            this.randomMenuItem});
            ...
            this.sequentialMenuItem.Click += new System.EventHandler(this.sequentialMenuItem_Click);
            //
            // loopMenuItem
            //
            ...
            this.loopOneMenuItem.Click += new System.EventHandler(this.loopOneMenuItem_Click);
            //
            // randomMenuItem
            //
            ...
            this.standardQualityMenuItem,
            this.highQualityMenuItem,
            this.losslessQualityMenuItem,
            this.hiresQualityMenuItem,
            this.surroundHDQualityMenuItem,
            this.dolbyQualityMenuItem,
            ...
            this.standardQualityMenuItem.Click += new System.EventHandler(this.qualityMenuItem_Click);
            //
            // highQualityMenuItem
            //
            ...
            this.highQualityMenuItem.Click += new System.EventHandler(this.qualityMenuItem_Click);
            //
            // losslessQualityMenuItem
            //
            ...
            this.losslessQualityMenuItem.Click += new System.EventHandler(this.qualityMenuItem_Click);
            //
            // hiresQualityMenuItem
            //
            ...
            this.hiresQualityMenuItem.Click += new System.EventHandler(this.qualityMenuItem_Click);
            //
            // surroundHDQualityMenuItem
            //
            ...
            this.surroundHDQualityMenuItem.Click += new System.EventHandler(this.qualityMenuItem_Click);
            //
            // dolbyQualityMenuItem
            //
            ...
            this.dolbyQualityMenuItem.Click += new System.EventHandler(this.qualityMenuItem_Click);
            //
            // masterQualityMenuItem
            //
            ...
            this.masterQualityMenuItem.Click += new System.EventHandler(this.qualityMenuItem_Click);
            //
            // prevMenuItem
            //
            ...
            this.searchTypeComboBox.Enter += new System.EventHandler(this.searchTypeComboBox_Enter);
            this.searchTypeComboBox.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.searchTypeComboBox_KeyPress);
            //
            // searchTypeLabel
            //
            ...
            this.resultListView.SelectedIndexChanged += new System.EventHandler(this.resultListView_SelectedIndexChanged);  // ⭐ 新增
            //
            // columnHeader1
            //
            ...
            // columnHeader3
            //
            this.columnHeader3.Text = "歌手/创建者";
            this.columnHeader3.Width = 200;
            //
            // columnHeader4
            //
            this.columnHeader4.Text = "专辑/曲目数";
            this.columnHeader4.Width = 250;
            //
            // columnHeader5
            //
            this.columnHeader5.Text = "时长/描述";
            ...
            this.volumeTrackBar.KeyDown += new System.Windows.Forms.KeyEventHandler(this.volumeTrackBar_KeyDown);
            ...
            this.progressTrackBar.KeyDown += new System.Windows.Forms.KeyEventHandler(this.progressTrackBar_KeyDown);
            ...
            // currentSongLabel
            //
            this.currentSongLabel.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
            | System.Windows.Forms.AnchorStyles.Right)));
            ...
            this.subscribePlaylistMenuItem.Click += new System.EventHandler(this.subscribePlaylistMenuItem_Click);
            //
            // unsubscribePlaylistMenuItem
            //
            ...
            this.unsubscribePlaylistMenuItem.Click += new System.EventHandler(this.unsubscribePlaylistMenuItem_Click);
            //
            ...
            this.subscribeAlbumMenuItem.Click += new System.EventHandler(this.subscribeAlbumMenuItem_Click);
            //
            // unsubscribeAlbumMenuItem
            //
        ...
        private System.Windows.Forms.ToolStripMenuItem playPauseMenuItem;
        private System.Windows.Forms.ToolStripSeparator toolStripSeparator1;
        private System.Windows.Forms.ToolStripMenuItem playbackMenuItem;
        private System.Windows.Forms.ToolStripMenuItem sequentialMenuItem;
        ...
        private System.Windows.Forms.ToolStripMenuItem hiresQualityMenuItem;
        private System.Windows.Forms.ToolStripMenuItem surroundHDQualityMenuItem;
        private System.Windows.Forms.ToolStripMenuItem dolbyQualityMenuItem;
        private System.Windows.Forms.ToolStripMenuItem masterQualityMenuItem;
